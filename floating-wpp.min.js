! function (v) {
    v.fn.floatingWhatsApp = function (e) {
        ...
        if (p.addClass("floating-wpp-button-image"), s.addClass("floating-wpp-button").append(v(i.buttonImage)).css({
            ...
            l.addClass("floating-wpp-popup"), c.addClass("floating-wpp-head"), d.addClass("floating-wpp-message"), r.addClass("floating-wpp-input-message"), m.addClass("floating-wpp-btn-send"), d.text(i.popupMessage), g.val(i.message), i.popupMessage || d.hide(), c.append("<div class='container'><div class='fixed'><img src='./kofi.png' alt=''></div><div class='flex-item'>              <h3>Hi, Im Kofi</h3><p style='font-size: 0.8em !important;margin-top: 5px !important;'>You can ask me any question</p></div></div>", h).css("background-color", i.headerColor), m.append(w), r.append(g, m), h.addClass("close").html("&times;"), l.append(c, d, r).appendTo(this), d.click(function () {}), h.click(function () {}), c.click(function () {
